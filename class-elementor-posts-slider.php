<?php
/**
 * DMA_ELEMENTOR_POSTS_SLIDER class.
 *
 * @category   Class
...
/**
 * Main Elementor PostsSlider Class
 *
 * The init class that runs the Elementor PostsSlider plugin.
 ...
 */
final class DMA_ELEMENTOR_POSTS_SLIDER {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-PostsSlider' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( DMA_ELEMENTOR_POSTS_SLIDER ) );
...
// Instantiate DMA_ELEMENTOR_POSTS_SLIDER.
new DMA_ELEMENTOR_POSTS_SLIDER();
